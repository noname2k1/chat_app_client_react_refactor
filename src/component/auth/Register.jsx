  ...
  return (
    <form className="auth-body-item register">
      {registerForm.map((formItem, index) => {
        return (
          <div className={`form-group ${formItem.name}`} key={formItem.index}>
            ...
            <div className="input-wrapper">
              ...
              >
                {typeInputPassWord === 'password' ? <BsEyeSlash /> : <BsEye />}
              </div>
            </div>
            ...
            {isErrorPattern[formItem.name] && (
              <div className="error-message">{formItem.errorMessage}</div>
            )}
          </div>
        );
      })}
